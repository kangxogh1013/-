...
public class Zombie : LivingEntity
{
    ...
    public void Setup(ZombieData zombieData) {
        ...
        //렌더러가 사용 중인 매터리얼의 컬러를 변경, 외형 색이 변함
    ...
    private IEnumerator UpdatePath() {
        ...
        while (!dead)
        {
            ...
            else
            {
                ...
                // 20 유닛의 반지름을 가진 가상의 구를 그렸을때, 구와 경치는 모든 콜라이더를 가져옴
                // 단, target Layers에 해당하는 레이어를 콜라이 가져오도록 필터링
